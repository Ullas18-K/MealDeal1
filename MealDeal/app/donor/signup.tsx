  ...
  const handleSignup = async () => {
    ...
    try {
      const response = await fetch(`${API_URL}/register`, {
        ...
        body: JSON.stringify({ name, email, password, phone, role: 'donor' }),
      });
      ...
      if (Platform.OS === 'web') {
        ...
        Alert.alert('Success', successMessage, [{ text: 'OK', onPress: () => router.replace('/donor') }]);
      }
    } catch (error: any) {
    ...
    <LinearGradient colors={gradient} style={styles.container}>
      <ScrollView contentContainerStyle={styles.scroll} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.title}>List your hotel or kitchen on MealDeal</Text>
          <Text style={styles.subtitle}>
            Verified partners can publish surplus batches, set pickup windows, and view NGO demand heatmaps.
          </Text>
        </View>

        <View style={styles.card}>
          <Text style={styles.cardTitle}>Create donor workspace</Text>
          <Text style={styles.cardSubtitle}>Tell us how to reach your operations lead.</Text>

          <TextInput
            style={styles.input}
            placeholder="Property / kitchen name *"
          ...
          <View style={styles.footerRow}>
            ...
            <TouchableOpacity onPress={() => router.replace('/donor')}>
